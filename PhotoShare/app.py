...
def viewLikes():
	if request.method == 'POST': 
		...
		cursor.execute("SELECT l.user_id, t.caption, t.content FROM Likes l, Users u, Text t WHERE u.user_id = '{0}' AND t.user_id = u.user_id AND t.text_id = l.text_id".format(uid)) 
